...
file under:
  kmip/v1.0/XML/{mandatory,optional}
...
Usage:
  python3 kmip/v1.4/XML/extract_kmip_xml_vectors.py \
    --html "kmip/v1.0/KMIP Asymmetric Key Lifecycle Profile Version 1.0.html" \
    --out-root kmip/v1.0/XML
